...
public class DatabaseInitializer {
    ...
    private static final String DB_URL = EnvConfig.getDbUrl();
    private static final String DB_NAME = EnvConfig.getDbName();
    private static final String DB_USER = EnvConfig.getDbUser();
